# -*- coding: utf-8 -*-
"""
Created on Sun Dec 25 22:44:47 2022
...
for id in tqdm(range(49,64)):  
    ...
    # Instantiate model 
    lasso = LassoCV(alphas=np.arange(0.00001, 1, 0.05), cv=10)
    lasso.fit(X, y)
    print("\nBest alpha value: ", lasso.alpha_)
    LassoReg = Lasso(alpha=lasso.alpha_, max_iter=n_est)
    ...
    importances=np.abs(LassoReg.coef_)
    ...
    feat_sel_data.to_csv(r'/home/UFAD/shajib.ghosh/CompStat_Feature_Selection/Supervised/Embedded/Results/Lasso/'+'Lasso_K'+str(k)+'_'+id+'.csv', index = None)
...
df_results.to_csv(r'/home/UFAD/shajib.ghosh/CompStat_Feature_Selection/Supervised/Embedded/Results/'+ 'Lasso_Regression_summary.csv')
print("Process completed for Feature Selection using Lasso Regression.")